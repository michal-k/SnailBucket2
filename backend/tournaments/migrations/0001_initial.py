# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-03-20 14:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reliability', models.IntegerField(default=4, help_text='Reliability rating.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roundsgen_rounds_start_cron', models.CharField(default='0 0 * * Wed', help_text='Starting date of every round, in crontab format. E.g. "0 0 * * Wed" for weekly or "0 0 3 * *" for monthly.', max_length=32)),
            ],
        ),
        migrations.CreateModel(
