...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, primary_key=True, auto_created=True)),
                ('bucket', models.ForeignKey(help_text='Player of which bucket.', to='tournaments.Bucket', related_name='players')),
            ],
        ),
        migrations.CreateModel(
            name='Game',
            fields=[
                ...
                ('scheduled_time', models.DateTimeField(help_text='Scheduled date of a game.', null=True, blank=True)),
                ('played_time', models.DateTimeField(help_text='Time when then game was finished.', null=True, blank=True)),
                ('result', models.CharField(max_length=16, help_text='Game status/result.')),
                ('pgn', models.TextField(help_text='Game in PGN format.', null=True, blank=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game_time', models.DateTimeField(help_text='Time of a game, if set in a message.', null=True, blank=True)),
        ...
        migrations.CreateModel(
            name='Member',
            fields=[
                ('user', models.OneToOneField(help_text='Basic account information, username, password, email, etc.', primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('country', models.CharField(help_text='Two letter country code of the member. Lowercase.', max_length=2, null=True, blank=True)),
                ('suspended_until', models.DateField(help_text='Until what date the user is suspended from games.', null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, primary_key=True, auto_created=True)),
                ('fixed_rating', models.IntegerField(help_text="Fixed raiting. If NULL, it means that the bot haven't filled the rating yet", null=True, blank=True)),
        ...
        migrations.AddField(
            ...
            name='member',
            field=models.ForeignKey(help_text='Author of a forum message, or NULL for bot message.', blank=True, null=True, to='tournaments.Member'),
        ),
        migrations.AddField(
            model_name='game',
            name='black_player',
            field=models.ForeignKey(help_text='Player who plays as black. Can be null in case of a bye.', blank=True, null=True, to='tournaments.Member', related_name='black_game'),
        ),
        migrations.AddField(
            model_name='game',
            name='bucket',
        ...
        migrations.AddField(
            model_name='game',
            name='white_player',
            field=models.ForeignKey(help_text='Player who plays as white. Can be null in case of a bye.', blank=True, null=True, to='tournaments.Member', related_name='white_game'),
        ),
        migrations.AddField(
